...
<nav aria-label='Page navigation example'>
    ...
    <li class='page-item'> <a class='page-link active' href= "../page_3/" >3</a> </li>
     ...
     <li class='page-item active'> <a class='page-link' href= "../page_5/" >5</a> </li>
...
<?php echo $dono; ?> / <?php echo $_SESSION['P03']; echo '/ pagina 5'; ?>
          </a>
...
<div class="row">
 ...
 <div class='card-header'><h3>Setor:</h3>4</div> 
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>secretaria_1</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="secretaria_1"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="secretaria_1"></input>
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>secretaria_2</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="secretaria_2"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="secretaria_2"></input>
       
       <button class='btn btn-secondary' t-ype='submit'>></button>
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>secretaria_3</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="secretaria_3"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="secretaria_3"></input>
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>mesa_1</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="mesa_1"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="mesa_1"></input>
