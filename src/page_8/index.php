...
<form action='./index_bck.php' method='post'>
      ...
      <input  name='p03' id='p01' type ='hidden' value="container"></input>
...
<form action='./index_bck.php' method='post'>
      ...
      <input  name='p03' id='p01' type ='hidden' value="documentation"></input>
...
<form action='./index_bck.php' method='post'>
      ...
      <input  name='p03' id='p01' type ='hidden' value="livro"></input>
...
<nav aria-label='Page navigation example'>
 ...
 <li class='page-item'> <a class='page-link' href= "../page_6/" >6</a> </li>
  ...
  <li class='page-item active'> <a class='page-link' href= "../page_8/index.php" >8</a> </li>
  <li class='page-item'> <a class='page-link' href= "../page_9/index.php" >9</a> </li>
...
<?php echo $dono; ?> / <?php echo $_SESSION['P03']; echo '/ pagina 8'; ?>
          </a>
...
<div class="row">
 ...
 <div class='card-header'><h3>Setor:</h3>8</div> 

<hr/> 



<form action='../../../cascaDEX/jover.html' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>repo_1</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='repo'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="link_1"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="repo"></input>
 ...
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>saida</div> 
      <div class='card-body text-dark'> 
       ...
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='saida para setor 10'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="saida"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="saida"></input>
