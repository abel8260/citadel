...
<nav aria-label='Page navigation example'>
    ...
    <li class='page-item active'> <a class='page-link' href= "../page_6/" >6</a> </li>
...
<?php echo $dono; ?> / <?php echo $_SESSION['P03']; echo '/ pagina 6'; ?>
          </a>
...
<div class="row">
 ...
 <div class='card-header'><h3>Setor:</h3>2</div> 
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>mesa_2</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="mesa_2"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="mesa_2"></input>
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>mesa_3</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="mesa_3"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="mesa_3"></input>
