...
<nav aria-label='Page navigation example'>
 ...
 <li class='page-item'> <a class='page-link' href= "../page_6/" >6</a> </li>
  <li class='page-item active'> <a class='page-link' href= "../page_7/" >7</a> </li>
...
<?php echo $dono; ?> / <?php echo $_SESSION['P03']; echo '/ pagina 7'; ?>
          </a>
...
<div class="row">
 ...
 <div class='card-header'><h3>Setor:</h3>7</div> 
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>cadeira_2</div> 
      ...
      <a href="./"> <button class='btn btn-primary' type='submit'>Entrar</button></a> 
       <button class='btn btn-secondary' type='submit'>-></button>
