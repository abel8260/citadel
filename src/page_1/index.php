...
<nav aria-label='Page navigation example'>
       <ul class='pagination justify-content-center'>
         ...
         <li class='page-item active'> <a class='page-link active' href= "../page_1/" >1</a> </li>
    ...
    <li class='page-item'> <a class='page-link active' href= "../page_3/" >3</a> </li>
...
<?php echo $dono; ?> / <?php echo $_SESSION['P03']; echo '/ pagina 1'; ?>
          </a>
...
<div class="row">
 ...
 <div class='card-header'><h3>Setor:</h3>1</div> 
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>checkpoint 1</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="Menu"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="menu"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>checkpoint 2</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="save_progress"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="save_progress"></input>
    <a href="./"> <button class='btn btn-primary' type='submit'><svg class="bi me-2" width="30" height="23" role="img" aria-label="Bootstrap"><use xlink:href="#bootstrap"/></svg></button></a>
      <button class='btn btn-secondary' type='submit'>-></button>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>checkpoint 3</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="start_process"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="start_process"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>Secretariado 1</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="Secretariado 1"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="Secretariado 1"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>Secretariado 2</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="Secretariado 2"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="Secretariado 2"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>DOC 1</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="documentações_1"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="documentações_1"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>DOC 2</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="documentações_2"></input>
      <a href="../page_3/"> <button class='btn btn-primary' type='submit'>entrada_para_corredor_da_agua</button></a>
      <input class='card-text' name='p02' id='p01' type ='hidden' value="documentações_2"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>DOC 3</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="documentações_3"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="documentações_3"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>INFRA 1</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="infraestrutura_1"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="infraestrutura_1"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>INFRA 2</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="infraestrutura_2"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="infraestrutura_2"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>INFRA 3</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="infraestrutura_3"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="infraestrutura_3"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>INFRA 4</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="infraestrutura_4"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="infraestrutura_4"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>INFRA 5</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="infraestrutura_5"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="infraestrutura_5"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>INFRA 6</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="infraestrutura_6"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="infraestrutura_6"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>INFRA 7</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="infraestrutura_7"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="infraestrutura_7"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>INFRA 8</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="infraestrutura_8"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="infraestrutura_8"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>INFRA 9</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="infraestrutura_9"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="infraestrutura_9"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>INFRA 10</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="infraestrutura_10"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="infraestrutura_10"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>container_1</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="container_1"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="container_1"></input>
 ...
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>container 2</div> 
      <div class='card-body text-dark'> 
       ...
       <input class='card-text' name='gold' id='p01' value="container_2"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="container_2"></input>
      <a href="./"> <button class='btn btn-primary' type='submit'>entrada_para_secretaria</button></a>
      <button class='btn btn-secondary' type='submit'>-></button>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>container 3</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="container_3"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="container_3"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>container 4</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="container_4"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="container_4"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>container 5</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="container_5"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="container_5"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>container 6</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="container_6"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="container_6"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>container 7</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="container_7"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="container_7"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>container 8</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="container_8"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="container_8"></input>
