...
<nav aria-label='Page navigation example'>
 ...
 <li class='page-item'> <a class='page-link' href= "../page_6/" >6</a> </li>
  ...
  <li class='page-item active'> <a class='page-link' href= "../page_10/" >10</a> </li>
  <li class='page-item '> <a class='page-link' href= "../page_11/" >11</a> </li>
      </ul>
        </nav>
 ...
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>vão_1</div> 
      ...
      <input class='card-text' name='p02' id='p01' type ='hidden' value="vão_1"></input>
       <a href="../page_8"><button class="btn btn-primary" type="text"> ENtrar </button></a>
