...
<nav aria-label='Page navigation example'>
    ...
    <li class='page-item active'> <a class='page-link active' href= "../page_3/" >3</a> </li>
...
<?php echo $dono; ?> / <?php echo $_SESSION['P03']; echo '/ pagina 3'; ?>
          </a>
...
<div class="row">
 ...
 <div class='card-header'><h3>Setor:</h3>5</div> 

<hr/> 



<form action='../page_3/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>vão 1</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="vao_1"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="vao_1"></input>
       
       <button class='btn btn-secondary' type='submit'>-></button>
       <button class='btn btn-primary' type='submit'>conserto & cia</button>
...
<form action='../page_3/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>vao_2</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="vao_2"></input>
      
       <input class='card-text' name='p02' id='p01' type ='hidden' value="vao_2"></input>
...
<form action='../page_3/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>vao_3</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="vao_3"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="vao_3"></input>
       
       <button class='btn btn-secondary' type='submit'>-></button>
       <button class='btn btn-primary' type='submit'>sala de invenções</button>
      </div>
     </div>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>vao 4</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="vao 4"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="vao 4"></input>
...
<form action='../page_3/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>vao 5</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="vao_5"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="vao_5"></input>
       
       <button class='btn btn-secondary' type='submit'>-></button>
       <button class='btn btn-primary' type='submit'>funkos</button>  
      </div>
     </div>
...
<form action='../page_3/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>vao_6</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="vao_6"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="vao_6"></input>
...
<form action='../page_3/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>agua 1</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="agua_1"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="beber agua_1"></input>
...
<form action='../page_3/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>agua_2</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="agua_2"></input>
      
       <input class='card-text' name='p02' id='p01' type ='hidden' value="beber agua_2"></input>
...
<form action='../page_3/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>agua_3</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="agua_3"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="beber agua_3"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>agua 4</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="agua 4"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="beber agua 4"></input>
...
<form action='../page_3/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>agua 5</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="agua_5"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="beber agua_5"></input>
...
<form action='../page_3/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>agua_6</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="agua_6"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="beber agua_6"></input>
...
<form action='../page_3/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>parede_1</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="parede_1"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="parede_1"></input>
...
<form action='../page_3/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>parede 2</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="parede 2"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="parede_2"></input>
...
<form action='../page_3/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>parede_3</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="parede_3"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="parede_3"></input>
