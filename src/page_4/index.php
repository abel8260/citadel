...
<nav aria-label='Page navigation example'>
    ...
    <li class='page-item'> <a class='page-link active' href= "../page_3/" >3</a> </li>
      ...
      <li class='page-item active'> <a class='page-link' href= "../page_4/" >4</a> </li>
...
<?php echo $dono; ?> / <?php echo $_SESSION['P03']; echo '/ pagina 4'; ?>
          </a>
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>cadeira_10</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="cadeira_10"></input>
  ...
  <form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>cadeira_11</div> 
      <div class='card-body text-dark'> 
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>cadeira_12</div> 
      <div class='card-body text-dark'> 
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>cadeira_13</div> 
      <div class='card-body text-dark'> 
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>cadeira_14</div> 
      <div class='card-body text-dark'> 
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>cadeira_15</div> 
      <div class='card-body text-dark'> 
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>cadeira_16</div> 
      <div class='card-body text-dark'> 
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>cadeira_17</div> 
      <div class='card-body text-dark'> 
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>cadeira_18</div> 
      <div class='card-body text-dark'> 
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>cadeira_19</div> 
      <div class='card-body text-dark'> 
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>cadeira_20</div> 
      <div class='card-body text-dark'> 
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>sala_D_star</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="sala_D_star"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="sala_D_star"></input>
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>biblioteca_1</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="biblioteca_1"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="biblioteca_1"></input>
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>biblioteca_2</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="biblioteca_2"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="biblioteca_2"></input>
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>biblioteca_3</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="biblioteca_3"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="biblioteca_3"></input>
