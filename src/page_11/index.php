...
<nav aria-label='Page navigation example'>
 ...
 <li class='page-item'> <a class='page-link' href= "../page_6/" >6</a> </li>
  <li class='page-item '> <a class='page-link' href= "../page_7/" >7</a> </li>
 <li class='page-item '> <a class='page-link' href= "../page_8/" >8</a> </li>
  <li class='page-item'> <a class='page-link' href= "../page_9/" >9</a> </li>
  <li class='page-item'> <a class='page-link' href= "../page_10/" >10</a> </li>
  <li class='page-item active'> <a class='page-link' href= "../page_11/" >11</a> </li>
      </ul>
        </nav>
...
<?php echo $dono; ?> / <?php echo $_SESSION['P03']; echo '/ pagina 10'; ?>
          </a>
...
<div class="row">
 ...
 <div class='card-header'><h3>Setor:</h3>10</div> 
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>vão_1</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="vão_1"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="vão_1"></input>
...
<form action='../page_5/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>vão_2</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="vão_2"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="vão_2"></input>
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>vão_3</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="vão_3"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="vão_3"></input>
...
<form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>vão_4</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="vão_4"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="vão_4"></input>
   ...
   <form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>vão_5</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="vão_5"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="vão_5"></input>
       <a href="#p01"><button class="btn btn-primary" type="text"> ENtrar </button></a>
       <button class='btn btn-secondary' type='submit'>-></button>
   ...
   <form action='../page_2/index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>vão_6</div> 
      <div class='card-body text-dark'> 
      
       <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="vão_6"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="vão_6"></input>
...
<form action='index_back.php' method='POST'> 
 <div class='card border-dark mb-3' style='max-width: 18rem;'> 
   <div class='card-header'>Balcão:</div> 
      <div class='card-body text-dark'> 
      
        <h5 class='card-title'><input type='submit' class='btn btn-secondary'  value='citadel1'  ></input></h5>
          
       <input class='card-text' name='gold' id='p01' value="Balcão"></input>
      
      <input class='card-text' name='p02' id='p01' type ='hidden' value="Balcão"></input>
           <button class='btn btn-secondary' type='submit'>-></button>
